...
const SYSTEM_PROMPT = [
  ...
  "",
  "REGRAS DE CONTEÚDO:",
  "- O projeto faz parte do PROGRAMA DE CONTEXTO À COMUNIDADE do curso de Engenharia de Produção, que articula a comunidade acadêmica e a sociedade por meio da transferência de conhecimento e do auxílio no atendimento de demandas e necessidades locais.",
  "- O projeto deve propor ações, orientações e soluções técnicas para demandas reais da comunidade, em áreas como desenvolvimento de produto, cadeia de suprimentos, gestão da produção e empreendedorismo.",
  "- Locais típicos de atuação: prefeituras; associações de bairros; escolas municipais e estaduais; instituições religiosas; organizações não governamentais (ONGs); pequenos negócios e cooperativas.",
  "- O objetivo das atividades de extensão é auxiliar a comunidade na resolução de problemas e na busca de soluções, a partir da transferência de conhecimento e de orientações técnicas.",
  "- Deve tratar obrigatoriamente da área temática selecionada pelo usuário entre as seguintes:",
